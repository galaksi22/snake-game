...
int main()
{
    ...
    while (!WindowShouldClose())
    {
        ...
        {
        case MENU:
            DrawText("Snake Game", GetScreenWidth() / 2.0f - 75, GetScreenHeight() / 4.0f, 30, YELLOW);
            DrawText("Tekan \"Enter\" untuk restart", 170, GetScreenHeight() / 2.0f, 20, WHITE);
        ...
        case PLAY:
            ...
            if (dead)
            {
                DrawText("Game Over", GetScreenWidth() / 2.0f - 75, GetScreenHeight() / 4.0f, 30, GREEN);
                DrawText("Tekan \"ENTER\" untuk restart", 200, GetScreenHeight() / 2.0f, 20, WHITE);
            }
            break;
        }
